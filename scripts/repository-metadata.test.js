...
describe("repository metadata", () => {
  ...
  it("keeps issue template version hints aligned with the current release line", () => {
    expect(read(".github/ISSUE_TEMPLATE.md")).not.toContain("v0.8.11");
    expect(read(".github/ISSUE_TEMPLATE/bug_report.yml")).not.toContain("v0.8.11");
    expect(read(".github/ISSUE_TEMPLATE.md")).toContain("v0.8.12");
    expect(read(".github/ISSUE_TEMPLATE/bug_report.yml")).toContain("v0.8.12");
  });
