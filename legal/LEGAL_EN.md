...
Original content in README, PRODUCT, DESIGN, CHANGELOG, and governance documents is released under **[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)**, unless otherwise noted.

## Brand and Official Assets

"薪跳", `PayDance`, the product logo, application icon, official posters, and other brand assets are **NOT** covered by the AGPL-3.0-only or CC BY-SA 4.0 licenses.
...
For closed-source integration, OEM, white-label, or brand licensing, please contact the author for a separate commercial license.
