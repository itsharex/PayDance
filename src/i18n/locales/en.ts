...
const en: Messages = {
  ...
  // ── Web Preview ────────────────────────────────────────────────────────
  "web.heroHeadline1": "Pay in Motion",
  "web.heroHeadline2": "Every Second",
  "web.heroLead": "A quiet local wage board for Windows.",
  "web.downloadWindows": "Download for Windows",
  "web.featureRealtime": "Live Ticker",
  "web.featureRealtimeDesc": "Earnings move with your workday",
  "web.featureFocus": "Corner-Friendly",
  "web.featureFocusDesc": "Dashboard or mini view, close at hand",
  "web.featurePrivacy": "Local by Design",
  "web.featurePrivacyDesc": "Salary and schedule stay on this device",
