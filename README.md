...
薪跳 PayDance 是一款桌面实时薪资仪表盘，也是一款属于打工人的桌面实时工资看板。输入薪资、工作日、上下班时间和休息扣除设置后，它会在桌面上实时显示今天已经挣到的钱，让每一秒的收入跳动都看得见。
...
| 工作时间建模 | 支持每月工作天数、每周工作日、普通日班、跨零点夜班和休息扣除 |
...
- 休息扣除：可选择剔除固定休息时段，让收入累计更贴近真实工时。
- 设置中心：按“薪资 / 作息 / 显示 / 关于”四组收纳配置，支持修改薪资、工作日、上班/下班时间、休息扣除、主题和金额动效。
